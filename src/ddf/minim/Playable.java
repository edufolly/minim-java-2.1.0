...
/**
 * <code>Playable</code> defines functionality that you would expect from a
 * tapedeck or CD player. Implementing classes are usually playing an audio
 * file.
 *
...
public interface Playable {
    ...
    /**
     * Starts playback from the current position. If this was previous set to
    ...
    /**
     * Starts playback
     * <code>millis</code> from the beginning. If this was previous set to loop,
     ...
     * <i>will not</i> be reset to the beginning. If this is not playing, it
     * will start playing.
     *
     */
    void loop();
    ...
    /**
     * Sets this to loop
     * <code>num</code> times. If this is already playing, the position <i>will
     * not</i> be reset to the beginning. If this is not playing, it will start
     * playing.
     *
     * @param num the number of times to loop
     */
    void loop(int num);

    /**
     * Returns true if this is currently playing and has more than one loop left
     * to play.
     *
     ...
     * <code>millis</code> milliseconds from the beginning. This will not change
     * the playstate. If an error occurs while trying to cue, the position will
     * not change. If you try to cue to a negative position or try to a position
     * that is greater than
     * <code>length()</code>, the amount will be clamped to zero or
     * <code>length()</code>.
     *
    ...
    /**
     * Skips
     * <code>millis</code> from the current position.
