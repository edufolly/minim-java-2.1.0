...
/**
 * An
 * <code>SignalChain</code> is a list of {@link AudioSignal AudioSignals} that
 * gives you the ability to enable (unmute) and disable (mute) signals. When you
 * add a signal, it is added to the end of the chain and is enabled. When you
 * remove a signal, signals further down the chain are moved up a slot.
 * <code>SignalChain</code> is itself an
 * <code>AudioSignal</code>, so you can easily create groups of signals that can
 * be enabled/disabled together by putting them in an
 * <code>SignalChain</code> and then adding that chain to a
 ...
 * then mixes all of the signals together.
 * <code>SignalChain</code> is fully
...
public class SignalChain implements AudioSignal {
    ...
    /**
     * Adds
     * <code>signal</code> to the end of the chain.
     *
     * @param signal the <code>AudioEffect</code> to add
     */
    ...
    /**
     * Removes
     * <code>signal</code> from the chain.
     *
     * @param signal the <code>AudioSignal</code> to remove
     */
     ...
     * <code>i</code><sup>th</sup> signal from the chain.
     *
     * @param i the index of the <code>AudioSignal</code> to remove
    ...
    /**
     * Gets the
     * <code>i<sup>th</sup></code> signal in the chain.
     *
     * @param i the index of the <code>AudioSignal</code> to get
     */
    ...
    /**
     * Enables the
     * <code>i</code><sup>th</sup> effect in the chain.
     *
    ...
    /**
     * Enables
     * <code>signal</code> if it is in the chain.
     *
     * @param signal the <code>AudioSignal</code> to enable
     */
    ...
    /**
     * Returns true if
     * <code>e</code> is in the chain and is enabled.
     *
     * @param signal the <code>AudioSignal</code> to return the status of
     ...
     * <code>signal</code> if it is in the chain.
     *
     * @param signal the <code>AudioSignal</code> to disable
     */
