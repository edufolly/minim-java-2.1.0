 ...
 * audio I/O. It provides control over the underlying
 * <code>DataLine</code>, which is a low-level JavaSound class that talks
 * directly to the audio hardware of the computer. This means that you can make
 * changes to the audio without having to manipulate the samples directly. The
 * downside to this is that when outputting sound to the system (such as with an
 * <code>AudioOutput</code>), these changes will not be present in the samples
 * made available to your program. <p> The
 * {@link #volume()}, {@link #gain()}, {@link #pan()}, and {@link #balance()}
 * methods return objects of type
 * <code>FloatControl</code>, which is a class defined by the JavaSound API. A
 * <code>FloatControl</code> represents a control of a line that holds a
 * <code>float</code> value. This value has an associated maximum and minimum
 * value (such as between -1 and 1 for pan), and also a unit type (such as dB
 * for gain). You should refer to the <a
 * href="http://java.sun.com/j2se/1.5.0/docs/api/javax/sound/sampled/FloatControl.html">FloatControl
 * Javadoc</a> for the full description of the methods available. <p> Not all
 * controls are available on all objects. Before calling the methods mentioned
 * above, you should call {@link #hasControl(javax.sound.sampled.Control.Type)}
 * with the control type you want to use. Alternatively, you can use the
 * <code>get</code> and
...
public class Controller {
    ...
    /**
     * Constructs a
     * <code>Controller</code> for the given
     * <code>Line</code>.
     *
    ...
    /**
     * Gets the volume control for the
     * <code>Line</code>, if it exists. You should check for the availability of
     * a volume control by using
    ...
    /**
     * Gets the gain control for the
     * <code>Line</code>, if it exists. You should check for the availability of
     * a gain control by using
     * {@link #hasControl(javax.sound.sampled.Control.Type)} before calling this
     * method.
     *
    ...
    /**
     * Gets the pan control for the
     * <code>Line</code>, if it exists. You should check for the availability of
     * a pan control by using
     * {@link #hasControl(javax.sound.sampled.Control.Type)} before calling this
     * method.
     *
    ...
    /**
     * Sets the volume to
     * <code>v</code>. If a volume control is not available, this does nothing.
     *
     * @param v the new value for the volume
     */
    ...
    /**
     * Shifts the value of the volume from
     * <code>from</code> to
     * <code>to</code> in the space of
     * <code>millis</code> milliseconds.
     *
     * @param from the starting volume
     * @param to the ending volume
     * @param millis the length of the transition
     */
    ...
    /**
     * Sets the gain to
     * <code>v</code>. If a gain control is not available, this does nothing.
     *
     * @param v the new value for the gain
     */
    ...
    /**
     * Shifts the value of the gain from
     * <code>from</code> to
     * <code>to</code> in the space of
     * <code>millis</code>
     *
    ...
    /**
     * Returns the current balance of the line. This will be in the range [-1,
     * 1]. If a balance control is not available, this will do nothing.
     *
    ...
    /**
     * Sets the balance of the line to
     * <code>v</code>. The provided value should be in the range [-1, 1]. If a
     * balance control is not available, this will do nothing.
     *
     * @param v the new value for the balance
     */
    ...
    /**
     * Shifts the value of the balance from
     * <code>from</code> to
     * <code>to</code> in the space of
     * <code>millis</code> milliseconds.
     *
    ...
    /**
     * Sets the pan of the line to
     * <code>v</code>. The provided value should be in the range [-1, 1].
     *
     * @param v the new value for the pan
     */
    ...
    /**
     * Shifts the value of the pan from
     * <code>from</code> to
     * <code>to</code> in the space of
     * <code>millis</code> milliseconds.
     *
     * @param from the starting pan
     * @param to the ending pan
     * @param millis the length of the transition
     */
