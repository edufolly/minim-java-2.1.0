...
/**
 * An
 * <code>Effectable</code> object is simply one that can have
 * <code>AudioEffect</code>s attached to it. As with an audio track in a typical
 * DAW, you can enable and disable the effects on an
...
public interface Effectable {
    ...
    /**
     * Enables all effects currently attached to this. If you want to enable
     * only a single effect, use {@link #enableEffect(int)}.
     *
     */
    void effects();
    ...
    /**
     * Returns true if
     * <code>effect</code> is in the chain and is also enabled.
     *
     * @param effect the <code>AudioEffect</code> to check the status of
    ...
    /**
     * Returns the
     * <code>i<sup>th</sup></code> effect in the effect chain. This method is
     * not required to do bounds checking and may throw an
     * ArrayOutOfBoundsException if
     * <code>i</code> is larger than {@link #effectCount()}.
     *
     * @param i which effect to return
     *
    ...
    /**
     * Returns true if
     * <code>effect</code> is in the chain.
     *
    ...
    /**
     * Enables the
     * <code>i</code><sup>th</sup> effect in the effect chain.
     *
    ...
    /**
     * Enables
     * <code>effect</code> if it is in the chain.
     *
     * @param effect the <code>AudioEffect</code> to enable
     */
     ...
     * <code>effect</code> if it is in the chain.
     *
     * @param effect the <code>AudioEffect</code> to disable
     */
    void disableEffect(AudioEffect effect);

    /**
     * Removes
     * <code>effect</code> from the effects chain.
     *
     ...
     * <code>i<sup>th</sup></code> effect in the effect chain.
     *
     * @param i which effect to remove
