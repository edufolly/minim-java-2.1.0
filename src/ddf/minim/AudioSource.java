...
/**
 * An
 * <code>AudioSource</code> is a kind of wrapper around an
 * <code>AudioStream</code>. An
 * <code>AudioSource</code> will add its
 * <code>AudioBuffer</code>s as listeners on the stream so that you can access
 * the stream's samples without having to implement
 * <code>AudioListener</code> yourself. It also provides the
 * <code>Effectable</code> and
 * <code>Recordable</code> interface. Because an
 * <code>AudioStream</code> must be closed when you are finished with it, you
 * must remember to call {@link #close()} on any
 * <code>AudioSource</code>s you obtain from Minim, such as
 * <code>AudioInput</code>s,
 * <code>AudioOutput</code>s, and
...
public class AudioSource extends Controller implements Effectable, Recordable {
     ...
     * <code>right</code> contains the same samples as
     * <code>left</code>.
     */
     ...
     * a mono
     * <code>AudioSource</code>,
     * <code>mix</code> contains the same samples as
     * <code>left</code>.
     */
    ...
    /**
     * Constructs an
     * <code>AudioSource</code> that will subscribe to the samples in
     * <code>stream</code>. It is expected that the stream is using a
    ...
    /**
     * Closes the
     * <code>AudioStream</code> this was constructed with.
     *
     */
    public void close() {
        stream.close();
