...
/**
 * An
 * <code>AudioOutput</code> is used to generate audio with
 ...
 * and
 * <code>AudioOutput</code> merely delegates to the synth when signals are
 * added. You can get an
 * <code>AudioOutput</code> from
 * <code>Minim</code> by calling one of the
 * <code>getLineOut</code> methods.
 *
...
public class AudioOutput extends AudioSource implements Polyphonic {
    ...
    /**
     * Constructs an
     * <code>AudioOutput</code> that will subscribe its buffers to
     * <code>synthesizer</code> and be able to control the
     * <code>DataLine</code> the synthesizer uses for output. If the synth does
     * not have an associated
     * <code>DataLine</code>, then calls to
     * <code>Controller</code>'s methods will result in a
     * <code>NullPointerException</code>.
     *
     * @param synthesizer the <code>AudioSynthesizer</code> to subscribe to
     */
