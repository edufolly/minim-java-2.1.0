...
public interface Polyphonic {
    ...
    /**
     * Enables all signals currently attached to this. If you want to enable
     * only a single signal, use {@link #enableSignal(int)}.
     *
     */
    void sound();
    ...
    /**
     * Returns true if
     * <code>signal</code> is in the chain and is also enabled.
     *
     * @param signal the <code>AudioSignal</code> to check the status of
     ...
     *
     * @param signal the <code>AudioSignal</code> to add
     */
    void addSignal(AudioSignal signal);

    /**
     * Returns the
     * <code>i<sup>th</sup></code> signal in the signal chain. This method is
     * not required to do bounds checking and may throw an
     * ArrayOutOfBoundsException if
     * <code>i</code> is larger than {@link #signalCount()}.
     *
     * @param i which signal to return
     *
    ...
    /**
     * Enables the
     * <code>i</code><sup>th</sup> signal in the signal chain.
     *
     * @param i the index of the signal to enable
     */
     ...
     * <code>i</code><sup>th</sup> signal in the signal chain.
     *
     * @param i the index of the signal to disable
     */
    ...
    /**
     * Removes
     * <code>signal</code> from the signals chain.
     *
     * @param signal the AudioSignal to remove
     */
    void removeSignal(AudioSignal signal);

    /**
     * Removes and returns the
     * <code>i<sup>th</sup></code> signal in the signal chain.
     *
     * @param i which signal to remove
