...
final class MAudioBuffer implements AudioBuffer {
    ...
    /**
     * Constructs and MAudioBuffer that is
     * <code>bufferSize</code> samples long.
     *
    ...
    /**
     * Mixes the two float arrays and puts the result in this buffer. The passed
     * arrays must be the same length as this buffer. If they are not, an error
     * will be reported and nothing will be done. The mixing function is: <p>
