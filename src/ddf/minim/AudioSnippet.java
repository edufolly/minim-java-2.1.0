 ...
 * <code>AudioSnippet</code> by using {@link Minim#loadSnippet(String)}. One of
 * the limitations of
 * <code>AudioSnippet</code> is that you do not have access to the audio samples
 * as they are played. However, you are spared all of the overhead associated
 * with making samples available. An
...
public class AudioSnippet extends Controller implements Playable {
     ...
     * This should be called when you are finished using this snippet.
     *
     */
    public void close() {
        recording.close();
