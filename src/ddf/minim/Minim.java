...
/**
 * The
 * <code>Minim</code> class is how you get what you want from JavaSound. There
 * are methods for obtaining objects for playing audio files:
 ...
 * <code>Minim</code>, which are
 * <code>Thread</code>s that do the actual work of audio I/O. Because of this,
 * you should always call the
 * <code>close</code> method of an AudioXXX when you are finished with it. <p>
...
public class Minim {
     ...
     *
     * @param parent the PApplet that will be used for loading files
     */
     ...
     *
     * @param parent the PApplet that will be used for loading files
     * @param msp the MinimServiceProvider that will be used for returning audio
     * resources
     */
     ...
     * MinimServiceProvider.
     *
     * @param mixer The Mixer we should try to acquire outputs from.
     */
     ...
     * @param format the format to play the samples back at
     */
     ...
     *
     * @param samples the samples to use
     * @param format the format to play them back at
     * @param bufferSize the output buffer size to use
     */
     ...
     *
     * @param left the left channel of the sample
     * @param right the right channel of the sample
     * @param format the format the sample should be played back with
     */
     ...
     * @param right the right channel of the sample
     * @param format the format the sample should be played back with
     * @param bufferSize the output buffer size desired
     */
     ...
     *
     * @param filename the file or URL that you want to load
     * @param bufferSize the sample buffer size you want
     ...
     * @param inMemory whether or not the file should be cached in memory as it
     * is read
    ...
    /**
     * Creates an {@link AudioRecorder} that will use
     * <code>source</code> as its record source and that will save to the file
     * name specified. The format of the file will be inferred from the
    ...
    /**
     * Gets an {@link AudioInput}, to which you can attach
     * {@link AudioEffect AudioEffects}.
     *
     ...
     *
     * @param type Minim.MONO or Minim.STEREO
     * @param bufferSize how long you want the <code>AudioInput</code>'s sample
     * buffer to be
     ...
     * @param bufferSize how long you want the <code>AudioInput</code>'s sample
     * buffer to be
     * @param sampleRate the desired sample rate in Hertz (typically 44100)
     ...
     * buffer to be
     * @param sampleRate the desired sample rate in Hertz (typically 44100)
     * @param bitDepth the desired bit depth (typically 16)
     ...
     *
     * @param type Minim.MONO or Minim.STEREO
     * @param bufferSize how long you want the <code>AudioOutput</code>'s sample
     * buffer to be
    ...
    /**
     * Play a note for the given duration, starting right now, at the given
     * frequency.
     *
     * @param duration
     * @param frequency
    ...
    /**
     * Play a note startTime seconds from now, for the given duration, at the
     * given frequency.
     *
     * @param startTime
     * @param duration
